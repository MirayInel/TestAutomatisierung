...
//	ArrayList<By> player_Elem = new ArrayList<>();	
//	
//	
...
//	l_GlobHeadElem.add(TVElements.gh_pulsweb);
...
//		driver = concreteDriver;
		...
		driver.get("http://www.t-online.de/tv/webclips/spektakulaere-videos/id_76833174/so-geht-bagger-abladen-fuer-fortgeschrittene.html");
...
//		testset.add(new TC704_Globalen_Header_Linkziel());
		testset.add(new Player_Elements());
